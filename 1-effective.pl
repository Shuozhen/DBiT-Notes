...
chomp (my $barcodefile = `ls /gpfs/ysm/project/fan/sb2723/00.database/barcode.xls`);
...
open OUT_1,">:gzip","$outdir/$insertsize/$insertsize.R1.fq.gz" or die $!;
open OUT_2,">:gzip","$outdir/$insertsize/$insertsize.R2.fq.gz" or die $!;

open OUT_3,">:gzip","$outdir/$insertsize/$insertsize.used.original.R1.fq.gz" or die $!;
open OUT_4,">:gzip","$outdir/$insertsize/$insertsize.used.original.R2.fq.gz" or die $!;

open OUT_5,">:gzip","$outdir/$insertsize/$insertsize.useless.R1.fq.gz" or die $!;
open OUT_6,">:gzip","$outdir/$insertsize/$insertsize.useless.R2.fq.gz" or die $!;
